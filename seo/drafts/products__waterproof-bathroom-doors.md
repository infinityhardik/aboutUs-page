# Draft expansion — products/waterproof-bathroom-doors.html

- **URL:** https://mahadev-traders.com/products/waterproof-bathroom-doors.html
- **Title:** Waterproof Bathroom Doors Rajkot | BWP, 30-35mm
- **Current length:** 1023 words
- **Trade fields present:** grade, thickness options, core material, IS certification, typical applications, delivery coverage
- **Trade fields missing:** standard sheet sizes, price band, MOQ
...
- `TODO(seo)`: The page mentions a 10mm thickness alongside 30-35mm - is the 10mm a PVC or WPC door rather than a BWP flush door? If both types are stocked they should be distinguished on the page.
