# Draft expansion — products/flexible-plywood-supplier.html

- **URL:** https://mahadev-traders.com/products/flexible-plywood-supplier.html
- **Title:** Flexible Plywood Rajkot | 4, 6, 8 &amp; 12mm Bendy Ply
- **Current length:** 1274 words
- **Trade fields present:** grade, thickness options, core material, typical applications, price policy, MOQ, delivery policy
...
- `TODO(seo)`: Standard sheet size for flexible plywood, and the minimum bend radius per thickness. The page claims a 5cm-10cm bend radius 'depending on thickness' without saying which thickness gives which.
