# Draft expansion — products/pine-wood-flush-doors.html

- **URL:** https://mahadev-traders.com/products/pine-wood-flush-doors.html
- **Title:** Pine Wood Flush Doors Rajkot | 30 to 40mm
- **Current length:** 1219 words
...
- `TODO(seo)`: Standard door sizes stocked, and whether the pine core is solid or a batten frame.
- `TODO(seo)`: Confirm whether these doors are made to IS 2202 like the other flush door lines.
